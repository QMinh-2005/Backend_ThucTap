...
namespace Backend_ThucTap.Service
{
    ...
    public class ProductService : IProductService
    {
        ...
        public ProductService(IProductRepository productRepository, ICategoryRepository categoryRepository, IBrandRepository brandRepository, IProductSerialRepository productSerialRepository, IProductImageRepository productImageRepository, IProductDetailRepository productDetailRepository)
        {
